...
from imagius.constants import APP_VERSION
from imagius.util import user_app_data_dir, settings_db_path, meta_db_path
...
def load_settings():
    ...
    if Version(SETTINGS['VERSION']) < Version(APP_VERSION):
        upgrade_from_previous_versions(
            Version(SETTINGS['VERSION']), meta_db_path())
